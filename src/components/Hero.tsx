...
const Hero = () => {
  ...
  return (
    <div className='container mt-20 mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden'>
      <div className='flex flex-col lg:flex-row justify-between items-center'>
        <div className='text-center lg:text-left mb-8 lg:mb-0 max-w-2xl'>
          ...
          <p className='mt-5 text-gray-700 dark:text-gray-300'>
            ...
            do. Crafting exceptional user experiences with React and Vue. Let's
